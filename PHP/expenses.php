...
<body>
   ...
   <form method="post">
      <div class="form-group">
          <label id="pasteLabel" for="submitInputTextArea">Paste Your Expences Input As hinted </label>
          
        <textarea placeholder="University ID,University Name,Education Expense,Research Expense,Salary Expense,Scholarship Expense,Transport Expense,Electricity Expense,Infrastructure Expense,Medical Expense,Music Expense" class="form-control" rows="15" id="submitInputTextArea" name="submitInputTextArea"></textarea>
        </div>

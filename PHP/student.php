...
<body>
  ...
  $sql = "CREATE TABLE IF NOT EXISTS `STUDENT` (
    ...
    `AdmittedStudent` INT(10) NOT NULL,
    `FemaleStudent` INT(10) NOT NULL,
    `TotalStudentStudying` INT(10) NOT NULL,
    `TotalFemaleStudentStudying` INT(10) NOT NULL,
...
//}
  ...
  for($i=0;$i<$result;$i++)
  {
    ...
    $query = "INSERT INTO STUDENT (UniversityID,UniversityName,AdmittedStudent, FemaleStudent,TotalStudentStudying,TotalFemaleStudentStudying) VALUES
      ('$pieces[$value1]','$pieces[$value2]','$pieces[$value3]','$pieces[$value4]','$pieces[$value5]','$pieces[$value6]')";
      $i=$value6;
...
<a href="UniveristyStudentChartRepresentation.php">Show Chart</a

...
<html lang="en">
<head>
	<title>University Land Input Form</title>
	<meta charset="UTF-8">
...
<body>
	 ...
	 <form method="post">
    	<div class="form-group">
      		<label id="pasteLabel" for="submitInputTextArea">Paste Your University Land Input According to hint</label>
      		
		
      	<textarea placeholder="University ID,University Name,Total Project,Own Land, Rent Land" class="form-control" rows="15" id="submitInputTextArea" name="submitInputTextArea"></textarea>
  	  	</div>
	...
	$sql = "CREATE TABLE IF NOT EXISTS `UNIVERSITY` (
	  ...
	  `UniversityLand` VARCHAR(50) NOT NULL,
	  `UniversityOwnLand` VARCHAR(50) NOT NULL,
	  `UniversityRentLand` VARCHAR(50) NOT NULL,
...
//}
	...
	for($i=0;$i<$result;$i++)
	{
		...
		$query = "INSERT INTO UNIVERSITY (UniversityID,UniversityName, UniversityLand,UniversityOwnLand,UniversityRentLand) VALUES
			('$pieces[$value1]','$pieces[$value2]','$pieces[$value3]','$pieces[$value4]','$pieces[$value5]')";
			$i=$value5;
...
?>
  	...
  	<a href="univesityLandChartRepresentation.php">Show Chart</a

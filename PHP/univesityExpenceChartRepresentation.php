<?php
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		$educationExpences = $educationExpences . '"'. $row['EducationExpense'] .'",';

		$researchExpence = $researchExpence . '"'. $row['ResearchExpense'] .'",';
		
		$salaryExpence = $salaryExpence . '"'. $row['SalaryExpense'] .'",';

		$scolarshipExpence = $scolarshipExpence . '"'. $row['ScholarshipExpense'] .'",';
	...
	$UniversityDataReplaced = str_replace(0, NULL, $scolarshipExpence);

	$universityNames = trim($universityNames,",");
	$educationExpences = trim($educationExpences,",");
	$researchExpence = trim($researchExpence,",");
	$salaryExpence = trim($salaryExpence,",");
	$scolarshipExpence = trim($UniversityDataReplaced,",");


	
		

	echo $scolarshipExpence;
...
<body>
	...
	<h2>Expense Representation </h2>

	<h2>Expense Representation of Education Expense </h2>
	...
	<div class="container">	
			...
			<script>
		        ...
		        data: {
		            ...
		            [{
		                ...
		                data: [<?php echo $educationExpences ?>],
	    ...
	    <h2>Expense Representation of Reserch Expense </h2>
	  ...
	  <h2>Expense Representation of Salary Expense </h2>
        ...
        scales: {
            yAxes: [{
	    	    ...
	    	    <h2>Expense Representation of Scolarship Expense </h2>
			...
			<script>
		        ...
		        data: {
		            ...
		            [{
		                ...
		                data: [<?php echo $scolarshipExpence ?>],
		                backgroundColor: 'aqua',
		                borderColor:'rgba(255,99,132)',
		                borderWidth: 3
		            }]
